...
@Pipeline
def axon_pipeline() -> ProcessingPipeline:  # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="Default LogRhythm Axon Pipeline",
        allowed_backends=frozenset(["axon"]),
        priority=10,
        items=[
            ProcessingItem(
                identifier="logrhythm_axon_field_mapping",
                transformation=FieldMappingTransformation({
                    # Common Fields in Windows Channels
                    ...
                    "DestinationHostname": ["target.host.name", "target.host.domain", ],
                    ...
                    "AccountDomain": "origin.account.domain	",
                    "AccountName": "origin.account.name",
                    ...
                    "TargetDomainName": "target.account.domain",
                    ...
                    "network_application": ["action.network.protocol.name", "object.url.protocol", ],
                    ...
                    "cs-host": ["target.host.name", "target.host.domain", ],
                    ...
                    "filename": "object.file.name",
                    "host": ["unattributed.host.name", "unattributed.host.ip_address.value", ],
                    ...
                    "result": ["action.result.message", "action.result.code", "action.result.reason", ],
                    ...
                    "clientIP": "origin.host.ip_address.value",
                    "dest_domain": ["target.host.name", "target.host.domain", ],
                    "dest_ip": "target.host.ip_address.value",
                    "dest_port": "target.host.network_port.value",
                    "agent.version": "object.file.version",
                    "destination.hostname": ["target.host.name", "target.host.domain", ],
                    "DestinationAddress": ["target.host.name", "target.host.domain", "target.host.ip_address.value", ],
                    "DestinationIP": "target.host.ip_address.value",
                    "dst-ip": "target.host.ip_address.value",
                    "dstip": "target.host.ip_address.value",
                    "dstport": "target.host.ip_address.value",
                    "Host": ["target.host.name", "target.host.domain", "target.host.ip_address.value", ],
                    "HostVersion": "object.file.version",
                    "http_host": ["target.host.name", "target.host.domain", "target.host.ip_address.value", ],
                    ...
                    "sender_domain": ["target.host.name", "target.host.domain", ],
                    "service.response_code": "action.result.code",
                    "source": ["origin.host.name", "origin.host.domain.name", "origin.host.ip_address.value", ],
                    ...
                    "UserAgent": "action.user_agent",
                    "User_Agent": "action.user_agent",
                    "web_dest": ["target.host.name", "target.host.domain", "target.host.ip_address.value",
                                 "object.url.domain", ],
                    "web.dest": ["target.host.name", "target.host.domain", "target.host.ip_address.value",
                                 "object.url.domain", ],
                    "Web.dest": ["target.host.name", "target.host.domain", "target.host.ip_address.value",
                                 "object.url.domain", ],
                    "web.host": ["target.host.name", "target.host.domain", "target.host.ip_address.value",
                                 "object.url.domain", ],
                    "Web.host": ["target.host.name", "target.host.domain", "target.host.ip_address.value",
                                 "object.url.domain", ],
                    ...
                    "Computer": ["target.host.name", "target.host.domain", "target.host.ip_address.value", ],
                    "OriginalFileName": "object.file.name",
                    "User": "origin.account.name",
                    "EventType": "action.command",
                    # Extra found
                    "TargetObject": ["object.registry_object.key", "object.registry_object.path",
                                     "object.resource.name", ],
                    "CommandLine": ["object.process.command_line", "object.process.command_args",
                                    "object.process.name", ],
                    "type": ["action.command", "action.type", "action.session.type", ],
                    "a0": ["object.process.command_line", "object.process.command_args", "object.process.name", ],
                    "cs-user-agent": "action.user_agent",
                    "blocked": ["action.message", "action.result.reason", ],
                }),
            )
        ]
    )
